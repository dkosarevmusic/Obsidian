...
OJSC.ui.createMonthGrid = (monthDate, tasksByDate, viewType, dv, onTaskDrop, statusMode, showTime, showParticipants) => {
    ...
    while (currentDay <= endDay) {
        const card = OJSC.ui.createDayCard(currentDay, tasksByDate, viewType, dv, onTaskDrop, statusMode, showTime, showParticipants);
