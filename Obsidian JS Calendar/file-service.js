...
OJSC.services.file = {
    ...
    /**
     * Устанавливает заданный статус задачи.
     * @param {object} dv - Глобальный объект API Dataview.
     * @param {string} filePath - Путь к файлу.
     * @param {string} newStatus - Новый статус для установки.
     */
    setTaskStatus: (dv, filePath, newStatus) => {
        return new Promise((resolve, reject) => {
            ...
            dv.app.fileManager.processFrontMatter(tfile, (fm) => {
                fm[OJSC.config.statusField] = newStatus;
